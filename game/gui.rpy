...
define gui.idle_color = '#e2dfdf'

## 小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果。
define gui.idle_small_color = '#ffffff'

## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#aaadaf'

## 当文本按钮被选中但非焦点时使用的颜色。当一个按钮为当前屏幕或设置选项值时，会
## 处于选中状态。
define gui.selected_color = '#5cc7fc'

## 当文本按钮无法被选择时使用的颜色。
define gui.insensitive_color = '#85b0cb7f'
...
## 游戏内文本使用的字体。
define gui.text_font = "Xiaolai-Regular.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "Xiaolai-Regular.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "Xiaolai-Regular.ttf"
...
define gui.choice_button_width = 856
define gui.choice_button_height = 150
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(150, 52, 150, 8)
...
define gui.history_text_width = 1210
